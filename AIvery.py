...
pronouns = ['he/him/his', "she/her/hers", "it/its", "fleur/fleurs", "they/them/theirs", "fae/faer/faers", "fey/fem/feirs"]
...
line("At present, I have He/Him/His, She/Her/Hers, They/Them/Theirs, and It/Its in my database.")
line("In addition to this, I am also familiar with a few sets of neopronouns. Would you like to view them?")
answer = input("Y/N>>> ")
...
if answer.lower() == 'y':
    line("Available neopronoun sets are: Fae/Faer/Faers, Fey/Fem/Feirs, Fleur/Fleurs.")
...
while pronoun_select.lower() not in pronouns:
    ...
    line("If you wish for your pronouns to be included in my database, please contact the developer.")
...
while True:
    ...
    if "what is your gender" in query.lower() or "what gender or you" in query.lower():
        ...
        line("Please try wording the query differently, or checking the list of available queries.")
        line("If you think there is an error or mistake, please report this to the developer.")